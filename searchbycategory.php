		...
		<div class="col-sm-2 col-md-5 col-lg-9">
			<div class="container-fluid" style="background-color:white;" id="subastas">
	      		...
	      		<div id="porNombre" style="display:none">
	      			<?php
		      			echo '<iframe frameborder="NO" onload="autofitIframe(this);" style="width:100%" src="DBquery/buscar_categoria.php?busqueda='.$_REQUEST['busqueda'].'&orden=Nombre">'.'</iframe>';
		      		?>
	      		</div>
	      		<div id="porFecha" style="display:none">
	      			<?php
		      			echo '<iframe frameborder="NO" onload="autofitIframe(this);" style="width:100%" src="DBquery/buscar_categoria.php?busqueda='.$_REQUEST['busqueda'].'&orden=Fec_init">'.'</iframe>';
		      		?>
	      		</div>
	      		<div id="porCategoria" style="display:none">
	      			<?php
		      			echo '<iframe frameborder="NO" onload="autofitIframe(this);" style="width:100%" src="DBquery/buscar_categoria.php?busqueda='.$_REQUEST['busqueda'].'&orden=cate">'.'</iframe>';
		      		?>
	      		</div>
      		</div>
		</div>
