                ...
                '<div class="panel-body">'.
                  ...
                  <?php if( ($_SESSION['id']==$reg['s_d']) && (!isset($reg['i_r']) ) ){
                    if ($reg['p_eli']==0 ){?>
                     ...
                     <p class="text-right"><textarea rows=1 cols=100 name="respuesta" style="width:100%; max-width:100%; height:50px" placeholder="Responder esta pregunta..." required></textarea>
